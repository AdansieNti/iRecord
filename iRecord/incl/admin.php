    ...
    <div class="nav-links">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                <a href="../pages/student.php" target="displayFrame" class="blue">Add Student</a>
                <a href="../pages/student_dmp.php" target="displayFrame" class="blue">Student CVSs </a>
                <a href="../pages/constructions.php" target="displayFrame" class="blue">Not Set</a>
            </div>
        </div>
        <a href="../pages/teacher.php" target="displayFrame" class="blue">Add Teacher</a>
        <div class="dropdown">
            <a href="#" class="blue">Assign Teacher</a>
            <div class="dropdown-content">
                <a href="../pages/teacher_class_subject.php" target="displayFrame" class="blue">Assign</a>
                <a href="../pages/teacher_class_subject_view.php" target="displayFrame" class="blue">View Assigned</a>
                <a href="../pages/constructions.php" target="displayFrame" class="blue">Not Set</a>
            </div>
        </div>
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                ...
                <a href="../pages/assessmentview.php" target="displayFrame" class="blue">Check Assessment</a>
                <a href="../pages/quiz.php" target="displayFrame" class="blue">Quizzes & Mocks</a>
                <a href="../pages/quizrpt.php" target="displayFrame" class="blue">Q & M Report</a>
                <a href="../pages/wkop.php" target="displayFrame" class="bluen"> Add Weekly Score</a>
                <a href="../pages/wkoprpt.php" target="displayFrame" class="bluen">Geneate 50% Score</a>
                <a href="../pages/wkopdld.php" target="displayFrame" class="blue"> View Weekly Scoret</a>
            </div>
        </div>
        <a href="../pages/report.php" target="displayFrame" class="blue">Report</a>
        ...
        <a href="../pages/promote_students.php" target="displayFrame" class="blue">Promotion</a>
        <a href="../index.php" class="blue">Logout</a>
    </div>

    <div class="main-content">
        <div class="left" id="leftSidebar">
            <a href="../pages/class.php" target="displayFrame" class="blue">Add Class</a>
            <a href="../pages/subject.php" target="displayFrame" class="blue">Add Subject</a>
            <a href="../pages/program.php" target="displayFrame" class="blue">Add Program</a>
            <a href="../pages/hall.php" target="displayFrame" class="blue">Add Hall</a>
            <a href="../pages/school_year.php" target="displayFrame" class="blue">Add School Year</a>
            <a href="../pages/semester.php" target="displayFrame" class="blue">Add Semester</a>
            ...
            <a href="../pages/users.php" target="displayFrame" class="blue">Manage Users</a>
